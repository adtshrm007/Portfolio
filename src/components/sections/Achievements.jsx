...
export default function Achievements() {
  ...
  return (
    <section id="achievements" ref={ref} className="relative py-28 md:py-36">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="mb-16">
          ...
          >
            ...
            <span className="text-[11px] text-gray-text tracking-[0.2em] uppercase font-medium">Milestones</span>
